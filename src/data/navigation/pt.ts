      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Educacao e EdTech', href: '/pt/industrias#edtech' },
            { label: 'Logistica e operacoes', href: '/pt/industrias#logistica' },
            { label: 'Solucoes internas empresariais', href: '/pt/industrias#internas' },
          ],
        },
        {
          title: 'Solucoes por industria',
          items: [
            { label: 'Plataformas imobiliarias', href: '/pt/industrias#inmobiliarias' },
            { label: 'Processamento de pagamentos', href: '/pt/industrias#pagos' },
            { label: 'Portais B2B e B2C', href: '/pt/industrias#portales' },
            { label: 'Gestao operacional e dashboards', href: '/pt/industrias#gestion' },
            { label: 'Automacao de processos', href: '/pt/industrias#automatizacion' },
            { label: 'Experiencias digitais', href: '/pt/industrias#experiencias' },
          ],
        },
      ],
    },
    casos: {
      ...
      columns: [
        ...
        },
        {
          ...
          items: [
            { label: 'Marketplace imobiliario', href: '/casos/' },
            { label: 'Plataforma freelancer-empresa', href: '/casos/' },
            { label: 'Solucao de pagamentos', href: '/casos/' },
            { label: 'Plataforma social ou de matching', href: '/casos/' },
            { label: 'Sistemas internos e automacao', href: '/casos/' },
            { label: 'MVPs e evolucao continua', href: '/casos/' },
          ],
        },
      ],
    },
    insights: {
      ...
      columns: [
        ...
        },
        {
          title: 'Destaques',
          items: [
            { label: 'Como validar um MVP', href: '/insights/' },
            { label: 'Quando modernizar uma plataforma', href: '/insights/' },
            { label: 'Integracoes de pagamento sem friccao', href: '/insights/' },
            { label: 'Arquitetura para produtos escalaveis', href: '/insights/' },
            { label: 'IA aplicada a processos empresariais', href: '/insights/' },
            { label: 'SEO e desempenho para plataformas', href: '/insights/' },
          ],
        },
      ],
    },
    nos: {
      ...
      columns: [
        ...
        },
        {
          title: 'Conheca',
          items: [
            { label: 'Nossa historia', href: '/nosotros/' },
            { label: 'Nossa visao', href: '/nosotros/' },
            { label: 'Nosso enfoque', href: '/nosotros/' },
            { label: 'Como trabalhamos', href: '/nosotros/' },
            { label: 'Cultura e valores', href: '/nosotros/' },
          ],
        },
        {
          title: 'Diferenciais',
          items: [
            { label: 'Peru como ponto de partida', href: '/nosotros/' },
            { label: 'Enfoque regional', href: '/nosotros/' },
            { label: 'Delivery agil e colaborativo', href: '/nosotros/' },
            { label: 'Excelencia tecnica', href: '/nosotros/' },
            { label: 'Design orientado a negocios', href: '/nosotros/' },
            { label: 'Relacoes de longo prazo', href: '/nosotros/' },
          ],
        },
      ],
    },
